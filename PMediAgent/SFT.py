...
def train(args, train_dataset, model, tokenizer):
    ...
    for e in train_iterator:
        ...
        loss_record.append((tr_loss - logging_loss) / (step+1))
...
def evaluate(args, model, tokenizer, save_output=False):
    ...
    eval_record.append(auto_scores)
...
def main():
    ...
    parser.add_argument('--data_name', default='cdm', type=str, #cdm
                        help="dataset name")
    parser.add_argument('--set_name', default='valid', type=str,
                        help="dataset split name")
    parser.add_argument('--model_name', default='bert', type=str,
                        help="model name")
    parser.add_argument("--model_name_or_path", default='./roberta-zh',
    ...
    parser.add_argument("--do_eval_cdm", action='store_true',
                        help="Whether to run cdm eval.")
    ...
    print("dataset name: ", args.data_name)
